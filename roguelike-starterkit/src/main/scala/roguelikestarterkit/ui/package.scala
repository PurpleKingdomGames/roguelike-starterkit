...
type TerminalTileColors = components.TerminalTileColors
val TerminalTileColors: components.TerminalTileColors.type = components.TerminalTileColors

// Terminal UI Datatypes
...
val TerminalWindow = window.TerminalWindow

type TerminalWindowChrome[ReferenceData] = window.TerminalWindowChrome[ReferenceData]
val TerminalWindowChrome: window.TerminalWindowChrome.type = window.TerminalWindowChrome
